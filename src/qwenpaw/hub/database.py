...
# fork stays the highest generation: upstream's rewritten hub-v1
# baseline (no trace_id, registration_mode) migrates INTO our v2,
# which adds the audit hash chain, groups/policies and archives.
