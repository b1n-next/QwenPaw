...
class QwenPawAgent(CodingModeMixin, Agent):
    ...
    async def _execute_tool_call(
        ...
        Tool-level hooks ride the same funnel: pre-call (allow /
        block / mutate arguments), then the base execution, then
        post-call or failure dispatch. Registered no-ops keep this
        a pass-through.
        """
