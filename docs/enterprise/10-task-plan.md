...
> **状态注记（2026-09-17 更新）**：**平台底座十票中七票已交付**
> （EP-2-1 组策略 / 2-2 OIDC / 2-3 配额 / 2-4 指标 / 2-5 备份 / 2-9 受限
> profile / 2-10 金丝雀）；**EP-2-6..8b（问数 M1-M4）按 2026-09-17 指示挂起，
> 待平台底座完善后启动**。Phase 2 整体 DoD（`enterprise/v0.3`）待问数面收口。
